...
sleep(5)
wait(Pattern("1555385646469.png").similar(0.80),240)

print("modulo encontrado")
paste(Pattern("1555191515556.png").targetOffset(-27,2), user_cms)
sleep(2)
type(Key.TAB)
sleep(2)
paste(pass_cms)
...
wait(Pattern("1558198815444.png").similar(0.80),240)
sleep(2)
...
sleep(1)
type(Key.ENTER)
wait(Pattern("1557957753205-9.png").similar(0.80),3600)
...
sleep(2)
wait(Pattern(Pattern("1560614596957-1.png").targetOffset(0,-1)).similar(0.8),600)
sleep(3)
type("w",KEY_CTRL)
sleep(2)